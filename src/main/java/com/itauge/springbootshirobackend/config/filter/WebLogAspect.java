package com.itauge.springbootshirobackend.config.filter;
...
public class WebLogAspect {
    ...
    @Pointcut("execution(public * com.itauge.springbootshirobackend.controller..*.*(..))")
    public void webLog(){
    }

    @Pointcut("execution(public * com.itauge.springbootshirobackend.config.exception.GlobalExceptionHandler.*(..))")
    public void exceptions(){
    }

    /**
     * 只在進入controller時記錄請求信息
     */
    @Before("webLog()")
    public void doBefore(JoinPoint joinPoint){
        ...
        log.debug("請求路徑{},進入方法{}",request.getRequestURI(),joinPoint.getSignature().getDeclaringTypeName() + ":" + joinPoint.getSignature().getName());
